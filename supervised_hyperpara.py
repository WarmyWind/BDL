...
parser.add_argument(
    "--method",
    default="BNN",
    choices=["BNN", "MCDropout", "DUE", "SNGP", "SVGP"],
    type=str,
    help="Specify method",
)
parser.add_argument("--task", default='large_channel_predict', type=str, help="Specify task")
parser.add_argument(
    "--dataset_path",
...
########################### BNN\MCDropout参数 ##################################
parser.add_argument("--sample_nbr", type=int, default=20, help="Number of MC samples to get loss")
...
# parser.add_argument(
#     "--norm_coeff", type=float, default=3, help="Spectral normalization coefficient"
# )
