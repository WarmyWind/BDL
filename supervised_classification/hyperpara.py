...
parser.add_argument(
    "--method",
    default="BNN",
    choices=["BNN", "MCDropout", "Ensemble", "EDL", 'DNN'],
    type=str,
    help="Specify method",
)
...
parser.add_argument("--task", default='HO_predict', type=str, help="Specify task")
...
parser.add_argument("--input_dim", type=int, default=35, help="input dimension")
parser.add_argument("--output_dim", type=int, default=7, help="output dimension, i.e. the number of classification")
parser.add_argument("--hidden_dim", type=int, default=256, help="NN hidden layer dimension")
parser.add_argument("--hidden_depth", type=int, default=2, help="Hidden layer depth for NN")
